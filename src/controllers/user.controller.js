...
//ham channel ke url pe jate hai for profile therefore params chahiye
    ...
    const user = await User.aggregate([
        ...
        },
        {
            $lookup:{
                ...
                foreignField:"_id",
                as:"watchHistory",
                pipeline:[//nested pipeline or sub-pipelines
                    {
                        $lookup:{
                            from:"users",
                            localField:"owner",
...
export {registerUser,loginUser,logOutUser,refreshAccessToken,changeCurrentPassword,getCurrentUser,updateAccountDetails,updateUserAvatar,updateUserCoverImgae,getUserChannelProfile,getWatchHistory}